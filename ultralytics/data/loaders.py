...
from ultralytics.data.multimodal import fuse_modalities, get_multimodal_settings, resolve_paired_image_path
...
class LoadImagesAndVideos:
    ...
    def __init__(self, path, batch=1, vid_stride=1):
        ...
        self.multimodal = get_multimodal_settings(self.hyp)
        parent = None
        ...
        while len(imgs) < self.bs:
            ...
            if self.video_flag[self.count]:
                ...
                if modality == "infrared":
                    ir_path = resolve_paired_image_path(path, self.multimodal)
                    im0 = cv2.imread(str(ir_path))
                elif self.hyp.ch < 4 or modality == "visible":
                    im0 = vis_im
                else:
                    ir_path = resolve_paired_image_path(path, self.multimodal)
                    ...
                    if vis_im is None or ir_im is None:
                        ...
                        im0 = fuse_modalities(vis_im, ir_im, self.multimodal["channel_order"])
